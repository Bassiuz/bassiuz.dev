...
import '../../core/extensions/widget_list_extension.dart';
...
@RoutePage()
class FluidUIPlaygroundPage extends StatefulWidget {
  const FluidUIPlaygroundPage({super.key});

  @override
  State<FluidUIPlaygroundPage> createState() => _PlaygroundPageState();
}

class _PlaygroundPageState extends State<FluidUIPlaygroundPage> {
  ...
  FluidConfig _config = const FluidConfig(1024,
      ...
      viewportConfig: ViewportConfig(maxViewportSize: 1200));

  PageType pageType = PageType.bassiuzDev;
        ...
        body: SingleChildScrollView(
          child: SliderScreenWrapper(
            ...
            child: switch (pageType) {
              PageType.bassiuzDev => MaterialApp.router(
                  title: 'Bas de Vaan - Software Developer',
                  builder: (context, child) => child!,
                  theme: bassiuzDevTheme(context, config: _config),
...
enum PageType { bassiuzDev, typefaceScale, mockupPage }
