...
class $AssetsGoogleFontsGen {
  ...
  /// File path: assets/google_fonts/FiraSans-Light.ttf
  ...
  /// File path: assets/google_fonts/FiraSans-SemiBold.ttf
  ...
  /// File path: assets/google_fonts/Rubik-BlackItalic.ttf
  String get rubikBlackItalic => 'assets/google_fonts/Rubik-BlackItalic.ttf';

  /// File path: assets/google_fonts/Rubik-Bold.ttf
  String get rubikBold => 'assets/google_fonts/Rubik-Bold.ttf';

  /// File path: assets/google_fonts/Rubik-BoldItalic.ttf
  String get rubikBoldItalic => 'assets/google_fonts/Rubik-BoldItalic.ttf';

  /// File path: assets/google_fonts/Rubik-ExtraBold.ttf
  ...
  /// File path: assets/google_fonts/Rubik-Light.ttf
  String get rubikLight => 'assets/google_fonts/Rubik-Light.ttf';

  /// File path: assets/google_fonts/Rubik-LightItalic.ttf
  String get rubikLightItalic => 'assets/google_fonts/Rubik-LightItalic.ttf';

  /// File path: assets/google_fonts/Rubik-Medium.ttf
  String get rubikMedium => 'assets/google_fonts/Rubik-Medium.ttf';

  /// File path: assets/google_fonts/Rubik-MediumItalic.ttf
  String get rubikMediumItalic => 'assets/google_fonts/Rubik-MediumItalic.ttf';

  /// File path: assets/google_fonts/Rubik-Regular.ttf
  String get rubikRegular => 'assets/google_fonts/Rubik-Regular.ttf';

  /// File path: assets/google_fonts/Rubik-SemiBold.ttf
...
class Assets {
  ...
  static const $AssetsBlogpostGen blogpost = $AssetsBlogpostGen();
